...
class QrCodeGeneratorImplTest {
    ...
    void singleValuedGenerateQrCode() throws IOException, WriterException {
        ...
        // Set up method
        qrCodeGenerator.generateQrCode("My Data", 500, 500, "./src/test/resources/images/my-single-valued-qr-code.jpg");
    ...
    void multiValuedGenerateQrCode() throws IOException, WriterException {
        ...
        // Set up method
        qrCodeGenerator.generateQrCode(dataList, 500, 500, "./src/test/resources/images/my-multi-valued-qr-code.jpg");
